...
class MentorService:
    ...
    def ask(self, request: MentorChatRequest) -> MentorChatResponse:
        ...
        if request.repo_url:
            ...
            # Try to read the README.md and PRD.md generated by Librarian
            readme_content = ""
            prd_content = ""
...
{"### 📚 Project README" if readme_content else ""}
{readme_content}

{"### 📋 Product Requirements Document (PRD)" if prd_content else ""}
{prd_content}

Use this data to give actionable, specific, and precise answers. Base your logic entirely on the provided context. If the user asks about something not in the context, guide them using general software engineering best practices, but clarify that it is not explicitly defined in the provided project context.
Ensure your response is well-formatted using markdown. Use code blocks, strong emphasis, and lists effectively to structure your explanations. Provide clear, accurate, and structured insights. """
        ...
        sources = ["app/core/sonar_client.py"]
